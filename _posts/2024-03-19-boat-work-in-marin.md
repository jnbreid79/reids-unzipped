---
title: "Boat work in Marin"
date: 2024-03-19
layout: post
author: Jamie Reid
location: Marin, Martinique
...
It's been a busy couple of weeks of boat work in Marin. We decided to take the opportunity whilst we're here, with the excellent facilities, to fix up all the issues and niggles we've encountered.
...
1. The mast — we had noticed movement and wear at the foot of the mast on our way across the Atlantic, this has been worrying us
2. Hydraulics, more hydraulic concerns (fortunately not the autopilot this time, that is now behaving perfectly and silently 👍) with the fluid levels in header tanks above each steering wheel going up and down by more than the height of each tank — i.e. alternately emptying and overflowing. To ensure we didn't get air into the system on either side we spent a lot of the passage moving fluid from one tank to the other, and vice versa (with Calpol syringes — as well as being perfect for measuring epoxy parts they really are useful!). We have been unable to get any confirmation as to whether we should expect the levels to change when sailing, or whether this did indeed pose a risk.

![Empty hydraulic header tank]({{ site.baseurl }}/assets/images/posts/img_5900.webp)
![Full hydraulic header tank]({{ site.baseurl }}/assets/images/posts/img_5904.webp)

One header tank empty and the other full to overflow

Mast panting and dust from foot plate wearing (when flying gennaker):

![Mast foot wear and dust]({{ site.baseurl }}/assets/images/posts/screenshot-2024-03-18-232107.webp)
...
![Zipper at anchor without mast]({{ site.baseurl }}/assets/images/posts/img_6059-1.webp)
![Mastless Zipper in anchorage]({{ site.baseurl }}/assets/images/posts/img_6051-1.webp)
...
![New welded mast foot plates]({{ site.baseurl }}/assets/images/posts/img_6161-1.webp)
![Mast foot after repair]({{ site.baseurl }}/assets/images/posts/img_6159-1.webp)
...
Today's good news was the thumbs up from the hydraulic expert here; we will now sail and simply let the fluid move between tanks without fretting or interfering, it seems that moving backwards and forwards is just what the fluid does on the (rare) two-wheel setup we have. As long as we don't lose it from both tanks…!

In the meantime we've been servicing our engines, but that's a story for another post…
